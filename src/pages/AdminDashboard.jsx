  ...
  return <main className="admin-dashboard"><div className="admin-container">
    ...
    <div className="admin-layout"><section className="admin-form-card">
      ...
      <form onSubmit={handleSubmit} className="admin-form">
        <div className="admin-form-row"><Field label="Product name"><input name="name" value={formData.name} onChange={handleChange} /></Field><Field label="URL slug" hint="Orofex-invoice"><input name="slug" value={formData.slug} onChange={handleChange} /></Field></div>
