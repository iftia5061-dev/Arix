...
function AdminDashboard() {
  ...
  return <main className="admin-dashboard"><div className="admin-container">
    <div className="admin-page-heading"><div><h1>Product management</h1><p>Publish sale products only after their price, Gumroad URL, demo, and content are complete. Gumroad handles payment and delivery.</p></div><span className="admin-role-badge">Admin</span></div>
    <div className="admin-layout"><section className="admin-form-card">
      ...
      <form onSubmit={handleSubmit} className="admin-form">
        ...
        <Field label="Demo URL"><input type="url" name="demoUrl" value={formData.demoUrl} onChange={handleChange} placeholder="https://..." /></Field>
        {saleProduct && <>
